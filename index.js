...
const SUPPORT_LINK = process.env.DISCORD_SUPPORT_URL || 'https://discord.gg/awYxnqfqRr';
    ...
    if (ended) {
        ...
        row = new ActionRowBuilder().addComponents(
            ...
            new ButtonBuilder()
                ...
                .setStyle(ButtonStyle.Link)
                .setURL('https://discord.gg/awYxnqfqRr')
        );
    } else {
    ...
    if (ticketChan) {
        try {
            ...
            const row = new ActionRowBuilder().addComponents(
                ...
                new ButtonBuilder().setLabel('🌐 Máy Chủ Hỗ Trợ').setStyle(ButtonStyle.Link).setURL('https://discord.gg/awYxnqfqRr')
            );
  ...
  try {
    ...
    if (interaction.isChatInputCommand()) {
        ...
        if (commandName === 'sendticket') {
            ...
            const linkURL = options.getString('đường_dẫn_nút_gắn_link') || 'https://discord.gg/awYxnqfqRr';
